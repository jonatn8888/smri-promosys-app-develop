<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UploadedFiles.aspx.vb" Inherits="UploadedFiles" %>
...
<body  style="background: white;">
    ...
    <div id="subvbAttachment">
        ...
        <asp:FileUpload ID="fileUpEx" runat="server" Height="23px" Width="363px" /></td>
                <td style="width: 72px; height: 24px;">
        <asp:Button ID="btnSubmit" runat="server" Height="23px" OnClick="btnSubmit_Click" Text="Add" Width="74px" /></td>
                <td style="width: 35px; height: 24px;">
                </td>
            </tr>
            <tr>
                <td colspan="3" style="height: 206px" valign="top">
