<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Seed.aspx.vb" Inherits="Seed" title="Untitled Page" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 100%; border-top-style: none; border-right-style: none; border-left-style: none;
            border-bottom-style: none;" id="doc-table">
                    ...
                    <tr id="trTPL_StartDate" runat="server">
                        <td style="width: 173px; height: 20px; text-align: left; padding-left: 60px;" valign="middle">Start Date:</td>
                        <td style="height: 20px; text-align: left;">
                            <asp:TextBox ID="txtStartDate" runat="server" Width="225px" MaxLength="50"></asp:TextBox>
                            <input name="calPeriodFrom" type="button" id="calPeriodFrom" class="btnCal" onclick="displayDatePicker('<%=txtStartDate.ClientID %>');" style="left: 322px; top: 345px" />
                        </td>
                    </tr>
                    <tr id="trTPL_EndDate" runat="server">
                        <td style="width: 173px; height: 20px; text-align: left; padding-left: 60px;" valign="middle">
                            End Date:</td>
                        <td style="height: 20px; text-align: left">
                            <asp:TextBox ID="txtEndDate" runat="server" Width="225px" MaxLength="50"></asp:TextBox>
                            <input name="calPeriodTo" type="button" id="calPeriodTo" class="btnCal" onclick="displayDatePicker('<%=txtEndDate.ClientID %>');" style="left: 547px; top: 345px"/>
                        </td>
                    </tr>
                    <tr id="trTPL_MaxNumber" runat="server">
                        <td style="width: 173px; height: 20px; text-align: left; padding-left: 60px;" valign="middle">
                            Max Number:</td>
                        <td style="height: 20px; text-align: left">
                            <asp:TextBox ID="txtMaxNumber" runat="server" MaxLength="50" Width="256px"></asp:TextBox></td>
                    </tr>
                    <tr id="trPL_Counter" runat="server">
                        <td style="width: 173px; height: 20px; text-align: left; padding-left: 60px;" valign="middle">
                            Counter:</td>
                        <td style="height: 20px; text-align: left">
                            <asp:TextBox ID="txtCounter" runat="server" MaxLength="50" Width="256px"></asp:TextBox></td>
                    </tr>
                    <tr id="trTPL_Price" runat="server">
                        <td style="width: 173px; height: 20px; text-align: left; padding-left: 60px;" valign="middle">Prize:</td>
                        <td style="height: 20px; text-align: left">
                            <asp:TextBox ID="txtPrice" runat="server" MaxLength="50" Width="256px"></asp:TextBox></td>
                    </tr>
                    <tr id="trTPL_linkSeeding" runat="server">
                        <td> &nbsp; </td>
                        <td style="padding-right: 10px;">
                            <asp:LinkButton style="padding-right: 10px;" ID="LinkButton1" runat="server" CssClass="action-link" Enabled="True">Remove Seed</asp:LinkButton>
                            <asp:LinkButton style="padding-right: 10px;" ID="linkSeeding" runat="server" CssClass="action-link" Enabled="True">Add Seed</asp:LinkButton>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <div style="padding-right: 2px; padding-left: 2px; padding-bottom: 2px; overflow: auto;
                            ...
                            <asp:GridView ID="gvSeeding" runat="server" AutoGenerateColumns="False" BorderStyle="Solid" DataSourceID="sqlDSPromoSeed"
        ...
        SelectCommand="SELECT PS.StartDate, PS.EndDate, PS.MaxNumber, PS.Counter, PS.Prize FROM PromoSeed PS WHERE RequestID = @RequestID" 
