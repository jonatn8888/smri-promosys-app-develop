...
Partial Class BankRangeGroup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            sqlds.SelectParameters("LoyaltyGroupId").DefaultValue = 0
            sqlds.SelectParameters("ViewType").DefaultValue = 0
            If txtSearchInput.Text.Trim() = "" Then
                sqlds.SelectParameters("Search").DefaultValue = " "
            Else
                sqlds.SelectParameters("Search").DefaultValue = txtSearchInput.Text.Trim()
            End If
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        If e.CommandName = "View" Then
            ...
            Response.Redirect("BankRangeGroupEntry.aspx?env=" & env & "&id=" & id)
        End If
    End Sub
End Class
