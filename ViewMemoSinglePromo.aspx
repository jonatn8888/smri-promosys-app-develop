<%@ Page Language="VB" MasterPageFile="~/PromoPage.master" AutoEventWireup="false" CodeFile="ViewMemoSinglePromo.aspx.vb" Inherits="ViewMemoSinglePromo" Title ="Promotional Memo" %>
 ...
 <script type="text/javascript">
    ...
    <div id="menu">
        ...
        <br />
            <asp:Panel ID="panSwipestakesMenu" runat="server" Visible=false>
                <asp:LinkButton ID="linkBinRange" runat="server" Visible="false">View Bin Range</asp:LinkButton><br />
                <br />
                <asp:LinkButton ID="linkSwipestakesMessage" runat="server" Visible="false">View Messages</asp:LinkButton><br />
            </asp:Panel>
    ...
    <table>
                ...
                <td colspan="2" style="width: 541px; border-right: black 1px solid; border-bottom: black 1px solid; height: 11px; border-top-width: 1px; border-left-width: 1px; border-left-color: black; border-top-color: black;">
                    ...
                    <tr   id="trRefMemos" runat="server" style="font-family: Trebuchet MS">
                        <td style="border-top-width: 1px; border-right: black 1px solid; border-left: black 1px solid;
                            ...
                            valign="top"><p><span style="font-size: 10pt"><span style="font-size: 9pt; font-family: Arial">
                            Reference
                            <br />
                        ...
                        <td colspan="2" style="border-top-width: 1px; border-right: black 1px solid; border-left-width: 1px;
                            ...
                            <div class="literal">
                            <asp:GridView ID="gridRefMemos" runat="server" AutoGenerateColumns="False" BorderColor="Black"
                                CellPadding="4" DataKeyNames="CRID" DataSourceID="sqlRefMemos" ForeColor="#333333"
                                ShowHeader="False" Width="554px">
                                ...
                                <Columns>
                                    <asp:TemplateField Visible="False">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hidCRID" runat="server" Value='<%# Bind("CRID") %>' />
                                            <asp:HiddenField ID="hidReqType" runat="server" Value='<%# Bind("REQUESTTYPE") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <td colspan="2" style="width: 541px; height: 5px; border-right: black 1px solid; border-top: black 1px solid; border-left-width: 1px; border-left-color: black; border-bottom: black 1px solid;">
                    ...
                    <tr style="font-family: Trebuchet MS">
                        ...
                        <td colspan="2" style="border-right: black 1px solid; border-top: black 1px solid;
                            ...
                            height: 5px">
                            <asp:Label ID="lblDeptSdept" runat="server" Font-Bold="False" Font-Size="9pt" Width="528px"></asp:Label></td>
                    </tr>
            <tr style="font-family: Trebuchet MS">
             ...
             <tr id="trRedeemPeriod" runat="server" style="font-family: Trebuchet MS">
                <td style="width: 554px; border-top-width: 1px; border-right: black 1px solid; border-left: black 1px solid; border-top-color: black; border-bottom: black 1px solid;">
                    <p><span style="font-size: 9pt"><strong>Redemption Period:</strong></span></p>
                </td>
                <td colspan="2" style="width: 541px; border-top-width: 1px; border-right: black 1px solid; border-left-width: 1px; border-left-color: black; border-top-color: black; border-bottom: black 1px solid;">
                     <asp:Label ID="lblRedeemPeriod" runat="server" Width="528px" Font-Size="9pt"></asp:Label>
                </td>
            </tr>           
			<tr style="font-family: Trebuchet MS">
            ...
            <tr style="font-family: Trebuchet MS">
                ...
                <div class="literal">
                                    <asp:GridView  ID="gridPromotions" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="PromoID" DataSourceID="sqldsPromos"
                                        ForeColor="#333333" Width="568px" Height="93px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" ShowHeader="False">
                                        <RowStyle BackColor="White" ForeColor="Black" />
                                        <Columns>
                                            <asp:TemplateField Visible="False">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundField DataField="ItemCode" HeaderText="Dp/SDp/Cl/SCl" ReadOnly="True" SortExpression="ItemCode" HtmlEncode="False" HtmlEncodeFormatString="False" Visible="False" >
                                                <ItemStyle HorizontalAlign="Center" Width="100px" VerticalAlign="Top" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="FormatPromoDesc" HeaderText="Description" SortExpression="PromoDesc" HtmlEncode="False" HtmlEncodeFormatString="False" >
                                                <HeaderStyle HorizontalAlign="Center" />                                                
        ...
        <asp:ImageButton ID="imgbtnDownload" runat="server" BackColor="White" BorderColor="White"
            ...
            Visible="False" /><asp:Literal ID="lblFiles" runat="server"></asp:Literal>
                   </td>
            </tr>
            </table>
            </div>
        ...
        <asp:SqlDataSource ID="sqldsPromos" runat="server" ConnectionString="<%$ ConnectionStrings:PromoConnectionString %>"
            SelectCommand="&#13;&#10;SELECT dbo.Fn_FormatPromoCode(D.DepCode,'Dp')+'-'+dbo.Fn_FormatPromoCode(D.SubDepCode,'SDp')+'-'+dbo.Fn_FormatPromoCode(D.ClassCode,'Cl')+'-'+dbo.Fn_FormatPromoCode(D.SubClassCode,'SCl')+ ' : ' +RTrim(D.ShortDesc) AS ItemCode,  P.PromoID, dbo.Fn_FormatPromoDesc(P.PromoID,@UserID) AS FormatPromoDesc, TypeDesc&#13;&#10;FROM Promotions P left outer join PromoDetails D ON P.PromoID = D.PromoID&#13;&#10;inner join PromoTypes PT ON P.PromoTypeID = PT.PromoTypeID  &#13;&#10;WHERE &#13;&#10;P.MemoID = @MemoID &#13;&#10;ORDER BY P.PromoID" UpdateCommand="UPDATE Promotions SET MemoID = @MemoID WHERE (RequestID = @RequestID)">
            <SelectParameters>
