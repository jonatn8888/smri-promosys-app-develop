...
Partial Class ViewMemo_Cancellation
    ...
    Private Sub ShowAttachments()
        ...
        If System.IO.Directory.Exists(strDir) Then
            ...
            For Each file As System.IO.FileInfo In files
                ...
                lblFiles.Text &= "<img src='Images/bullet green.gif' /><a href=""RCDPMemo.aspx?FileName=" & Server.UrlEncode(file.Name.ToString()) & "&MemoID=" & clsEncryptDecrypt.EncryptText(Request("MemoID").ToString, SystemUser.EncryptKey.ToString) & "&CRID=" & Request("CRID").ToString & "&v1=" & Request("v1").ToString & "&stat=" & Request("stat").ToString & """>" & file.Name.ToString() & "</a> "
            Next
