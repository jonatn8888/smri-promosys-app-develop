            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Memo Number">
                    ...
                    <ItemTemplate>
                        <asp:GridView ID="gvMemo" runat="server" AutoGenerateColumns="False"
                            ForeColor="#333333" OnRowCommand="gvMemo_RowCommand" ShowHeader="False" Width="219px" PageSize="3" CellPadding="4" GridLines="None">
                            <Columns>
                                <asp:TemplateField>
                                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="POS Files">
                    <ItemTemplate>
                        ...
                        <asp:GridView ID="GVChild" runat="server" AutoGenerateColumns="False" Visible="False" OnRowCommand="GVChild_RowCommand" Font-Size="9pt" ShowHeader="False" Width="180px"  PageSize="3" Height="96px" CellPadding="4" ForeColor="#333333" GridLines="None">
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("UploadDate") %>'></asp:TextBox>
