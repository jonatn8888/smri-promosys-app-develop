<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PromoRequestSwipestakesReseed.aspx.vb" Inherits="PromoRequestSwipestakesReseed" title="Untitled Page" %>
...
<body>
    <form id="form1" runat="server">
        ...
        SelectCommand="SELECT SUBSTRING(RIGHT('0000000'+ISNULL(CAST(PS.CompBranch AS nvarchar), ''),7),4,4) +' - '+ B.BranchName AS Branch, PS.StartDate, PS.EndDate, PS.MaxNumber, PS.Counter, PS.Prize FROM PromoSeedCR PS 
                            LEFT JOIN Branches B
                            ON SUBSTRING(RIGHT('0000000'+ISNULL(CAST(PS.CompBranch AS nvarchar), ''),7),4,4) = RIGHT('0000'+ISNULL(CAST(B.BranchCode AS nvarchar), ''),4)
                            WHERE RequestID = @RequestID AND CRID = @CRID
        ...
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="0" Name="CRID" />
        </SelectParameters>
        <InsertParameters>
