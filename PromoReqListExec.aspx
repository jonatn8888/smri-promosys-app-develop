<%@ Page Language="VB" MasterPageFile="~/PromoPage.master" AutoEventWireup="false" CodeFile="PromoReqListExec.aspx.vb" Inherits="PromoReqListExec" Title="Sales Promotion Request" %>
        ...
        &nbsp;<table style="width: 690px">
            ...
            <tr>
                ...
                <td style="width: 40%; text-align: right">
                    <asp:DropDownList ID="cboBizUnit" runat="server" AutoPostBack="True" Width="320px">
                    </asp:DropDownList></td>
            </tr>
        </table>
        <br />
