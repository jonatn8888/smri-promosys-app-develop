<%@ Page Language="VB"  AutoEventWireup="false" EnableEventValidation="false" CodeFile="SearchBranch.aspx.vb" Inherits="SearchBranch" title="Search Branch" %>
                        ...
                        <tr>
                            <td style="width: 688px; height: 176px" valign="top">
                                <asp:GridView ID="gridSearchResult" runat="server" AutoGenerateColumns="False" CellPadding="4" 
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="BranchCode" HeaderText="BrCode" >
                                        ...
                                        <asp:TemplateField  HeaderText="Branch Name" SortExpression="BranchName">
                                            ...
                                            <ItemStyle CssClass="ClippedRegion" Width="50%" HorizontalAlign="Left" />
                                        </asp:TemplateField>                                         
