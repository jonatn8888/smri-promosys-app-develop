<%@ Page Language="VB" MasterPageFile="~/PromoPage.master" AutoEventWireup="false" CodeFile="ViewMemo_Extension.aspx.vb" Inherits="ViewMemo_Extension" Title ="Promotional Memo Extension" %>                                                                                                                                                                           
    ...
    <table>
            ...
            <tr style="font-family: Trebuchet MS">
                 <td style="border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid;
                        ...
                        <span style="font-size: 9pt">Reference Memo:</span></td>
                 <td colspan="2" style="border-right: black 1px solid; border-top: black 1px solid;
                            ...
                            height: 5px">
                    <asp:Label ID="lblRefMemo" runat="server" Font-Size="9pt" Width="528px"></asp:Label></td>
            </tr>
           <tr style="font-family: Trebuchet MS">
            ...
            <tr id="trExtensionOfPromo" runat="server" style="font-family: Trebuchet MS">
                <td style="width: 554px; height: 100%; border-top-width: 1px; border-right: black 1px solid; border-left: black 1px solid; border-top-color: black; border-bottom: black 1px solid;" valign="top">
                    <p><span style="font-size: 9pt">Extension of Promotion</span></p></td>
                <td colspan="2" style="width: 541px; border-top-width: 1px; border-right: black 1px solid; border-left-width: 1px; border-left-color: black; border-top-color: black; border-bottom: black 1px solid" valign="top">
                    <table cellpadding="3px" cellspacing="0px" style="width: 569px" >
                        <tr style="font-family: Trebuchet MS">
                            <td style="border-top-width: 1px; border-right: black 1px solid; border-left: black 1px solid;
                                width: 60%; border-top-color: black; border-bottom: black 1px solid; height: 100%; border-top: black 1px solid"
                                valign="top">
                                Original Promo Duration</td>
                            <td colspan="2" style="border-top-width: 1px; border-right: black 1px solid; border-left-width: 1px;
                                border-left-color: black; border-top-color: black; border-bottom: black 1px solid; border-top: black 1px solid"
                                valign="top">
                                Extended until...</td>
                        </tr>
                        <tr style="font-family: Trebuchet MS">
                            <td style="border-top-width: 1px; border-right: black 1px solid; border-left: black 1px solid;
                                width: 50%; border-top-color: black; border-bottom: black 1px solid; height: 100%"
                                valign="top">
                        <asp:Label ID="lblPromoPeriod" runat="server" Font-Size="9pt" Width="100%"></asp:Label></td>
                            <td colspan="2" style="border-top-width: 1px; border-right: black 1px solid; border-left-width: 1px;
                                border-left-color: black; border-top-color: black; border-bottom: black 1px solid"
                                valign="top">
                             <asp:Label ID="lblExtPromoPeriod" runat="server" Font-Size="9pt" Width="100%"></asp:Label></td>
                        </tr>
                    </table>
            ...
            <tr id="trEffectDate" runat ="server" style="font-family: Trebuchet MS" visible="false">
                 <td style="border-right: black 1px solid;  border-left: black 1px solid;
                            width: 554px; border-bottom: black 1px solid; height: 5px">
                        <span style="font-size: 9pt">Effective Date:</span></td>
                 <td colspan="2" style="border-right: black 1px solid;
                            border-left-width: 1px; border-left-color: black; width: 541px; border-bottom: black 1px solid;
                            height: 5px">
                    <asp:Label ID="calCancelEffectDate" runat="server" Font-Size="9pt" Width="528px"></asp:Label></td>
            </tr>
            
            <tr id="trPromotions" runat ="server" style="font-family: Trebuchet MS">
