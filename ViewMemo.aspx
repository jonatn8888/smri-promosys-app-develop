<%@ Page Language="VB" MasterPageFile="~/PromoPage.master" AutoEventWireup="false" CodeFile="ViewMemo.aspx.vb" Inherits="ViewMemo" Title ="Promotional Memo" %>
...
<script type="text/javascript">
    ...
    function printSpecial_CCL()
    {
        if (document.getElementById != null)
        {
            var html = '<HTML>\n<HEAD>\n';
            /*html += '<link rel="stylesheet" type="text/css" href=".\css\watermark.css" media="print" />\n';*/
            html += '    <style type="text/css" media="print">\n'
            html += '    .watermark_ccl \n'
	        html += '    {\n'
	        html += '    background-image:url(images/cancelled2.gif);\n'
            ...
            html += '\n</HE>\n<BODY>\n';
            /*html += 'dow<style type="text/css"> body {background-image: url(images/cancelled2.gif) no-repeat center; } </style> '*/
            /*html += '<img src=\'images\cancelled2.gif';*/
            var printReadyElem = document.getElementById("mainMemo");
            
            html += ' <table style="width: 791px; height: 540px">\n';
            html += ' <tr>\n' ;
            html += ' <td class="watermark_ccl">\n';
            ...
            html += '\n</BO>\n</HT>';
            var printWin = window.open("","printSpecial_CCL");
            printWin.innerWidth =10;
            printWin.innerHeight = 10;
            printWin.screenX = screen.width;
            printWin.screenY = screen.height;
    ...
    <table>
            ...
            <tr style="font-family: Trebuchet MS">
             ...
             <tr  id="trRefMemos" runat="server" style="font-family: Trebuchet MS">
                <td style="border-top-width: 1px; border-right: black 1px solid; border-left: black 1px solid;
                    ...
                    valign="top">
                     <p><span style="font-size: 10pt"><span style="font-size: 9pt; font-family: Arial">
                    Reference <br />Memo(s)</span></span></p></td>
                <td colspan="2" style="border-top-width: 1px; border-right: black 1px solid; border-left-width: 1px;
                    ...
                    <div class="literal">
                        <asp:GridView ID="gridRefMemos" runat="server" AutoGenerateColumns="False" BorderColor="Black"
                            ...
                            <RowStyle BackColor="White" ForeColor="Black" Font-Size="9pt" />
                            <Columns>
            ...
            <tr style="font-family: Trebuchet MS">
                <td style="width: 554px; height: 5px; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid;">
                    <p><span style="font-size: 9pt">Promo Type</span></p></td>
            ...
            <tr id="trRedeemPeriod" runat="server" style="font-family: Trebuchet MS">
                <td style="width: 554px; border-top-width: 1px; border-right: black 1px solid; border-left: black 1px solid; border-top-color: black; border-bottom: black 1px solid;">
                    <p><span style="font-size: 9pt">Redemption Period:</span></p>
                </td>
                <td colspan="2" style="width: 541px; border-top-width: 1px; border-right: black 1px solid; border-left-width: 1px; border-left-color: black; border-top-color: black; border-bottom: black 1px solid;">
            ...
            <tr style="font-family: Trebuchet MS">
                ...
                <div class="literal">
                                    <asp:GridView  ID="gridPromotions" runat="server" CssClass="mGridTrans" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="PromoID"
                                        ...
                                        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                        <HeaderStyle Font-Bold="True" ForeColor="Black" Font-Size="9pt" Height="5px" Font-Names="Trebuchet MS" />
                                        <EditRowStyle BackColor="#999999" />
