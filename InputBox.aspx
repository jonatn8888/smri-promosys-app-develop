<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InputBox.aspx.vb" Inherits="InputBox" %>
                    ...
                    &nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td align="left" style="height: 21px; width: 382px;" colspan="2" valign="middle">
                                    ...
                                    <asp:TextBox ID="txtInputbox" runat="server" Width="367px" MaxLength="100"></asp:TextBox>
                                    <div id="errormessage" runat="server" style="width:352px; height:28px; overflow:auto; background-color: WhiteSmoke; padding: 10px 10px 10px 10px;">
