<%@ Page Language="VB" MasterPageFile="~/PromoPage.master" AutoEventWireup="false" CodeFile="ArchiveMemosView.aspx.vb" Inherits="ArchiveMemosView" Title ="Archive Memos" %>
...
<script type="text/javascript">
    ...
    <div id="menu">
        ...
        <br />
        <asp:LinkButton
            ID="lnkDone" runat="server">Back to Archive Memos</asp:LinkButton><br />
        <br />
    </div>
    ...
    <table>
                                    ...
                                    <asp:GridView  ID="gridPromotions" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="PromoID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ItemCode" HeaderText="Dp/SDp/Cl/SCl" ReadOnly="True" SortExpression="ItemCode" HtmlEncode="False" HtmlEncodeFormatString="False" >
                                                <ItemStyle HorizontalAlign="Center" Width="80px" VerticalAlign="Top" Font-Size="9pt" />
        ...
        SelectCommand="SELECT 1"></asp:SqlDataSource><asp:SqlDataSource ID="sqlDSFilter" runat="server" ConnectionString="<%$ ConnectionStrings:PromoConnectionString %>"
            SelectCommand="USP_ValidateHowManyPromotionsInAMemo" UpdateCommand="UPDATE PromoArchive.dbo.Promotions SET MemoID = @MemoID WHERE (RequestID = @RequestID)" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDSPromotype" runat="server" ConnectionString="<%$ ConnectionStrings:PromoConnectionString %>"
            SelectCommand="USP_SelectPromoTypeByMemoIDArc" SelectCommandType="StoredProcedure"
            UpdateCommand="UPDATE PromoArchive.dbo.Promotions SET MemoID = @MemoID WHERE (RequestID = @RequestID)">
            <SelectParameters>
                <asp:SessionParameter Name="MemoID" SessionField="CurrMemoID" />
            </SelectParameters>
        </asp:SqlDataSource>
